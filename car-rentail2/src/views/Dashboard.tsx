                    ...
                    <div className="d-flex flex-grow-1 overflow-hidden">
                        ...
                        <div className="filters-panel p-4 h-100 flex-shrink-0">
                            ...
                            <div className="mb-4">
                                ...
                                <div className="checkbox-grid">
                                    <div className="form-check custom-checkbox">
                                        <input className="form-check-input" type="checkbox" defaultChecked id="sedan" />
                                    ...
                                    <div className="form-check custom-checkbox">
                                        <input className="form-check-input" type="checkbox" defaultChecked id="coupe" />
                                        <label className="form-check-label fs-sm" htmlFor="coupe">Coupe</label>
                                    </div>
                                    <div className="form-check custom-checkbox">
                                        <input className="form-check-input" type="checkbox" defaultChecked id="hatchback" />
                                    ...
                                    <div className="form-check custom-checkbox">
                                        <input className="form-check-input" type="checkbox" defaultChecked id="crossover" />
                                        <label className="form-check-label fs-sm" htmlFor="crossover">Crossover</label>
                                    </div>
                                    <div className="form-check custom-checkbox">
                                        <input className="form-check-input" type="checkbox" defaultChecked id="van" />
                            ...
                            <div className="mb-4">
                                ...
                                <div className="checkbox-grid">
                                    <div className="form-check custom-checkbox">
                                        <input className="form-check-input" type="checkbox" defaultChecked id="gas" />
                                        <label className="form-check-label fs-sm" htmlFor="gas">Gasoline</label>
                                    </div>
                                    <div className="form-check custom-checkbox">
                                        <input className="form-check-input" type="checkbox" defaultChecked id="flex" />
                                    ...
                                    <div className="form-check custom-checkbox">
                                        <input className="form-check-input" type="checkbox" defaultChecked id="electric" />
